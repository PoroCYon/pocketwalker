...
struct ControlSettings
{
    ...
    int key_synthetic_steps_hold = Qt::Key_Up;
};
...
inline void to_json(nlohmann::json& j, const ControlSettings& s)
{
    j = nlohmann::json{
        ...
        {"key_synthetic_steps_hold", s.key_synthetic_steps_hold},
    };
}
...
inline void from_json(const nlohmann::json& j, ControlSettings& s)
{
    ...
    s.key_synthetic_steps_hold = j.value("key_synthetic_steps_hold", static_cast<int>(Qt::Key_Up));
}
